...
export const dict = {
  fa: {
    ...
    portfolio: {
      ...
      subtitle:
        "پروژه‌هایی که فرآیند طراحی محصول آن‌ها را از تحقیق تا طراحی نهایی هدایت کرده‌ام",
      viewProject: "مشاهده",
      // Modal
      modal: {
    ...
    experience: {
      ...
      title: "مسیر حرفه‌ای",
      subtitle:
        "سوابق حرفه‌ای و تجربه‌های کاری من در طراحی محصولات دیجیتال",
      present: "تاکنون",
    ...
    contact: {
      ...
      subtitle:
        "فرصت‌های جدید، تیم‌های پویا و چالش‌های تازه همیشه برام ارزشمندن",
      emailMe: "ارسال ایمیل",
  ...
  en: {
    ...
    contact: {
      ...
      subtitle:
        "New opportunities, dynamic teams, and fresh challenges are always valuable to me",
      emailMe: "Email me",
